...
import com.hirezy.composeuI.core.ui.components.tree.WeTreeNode
import com.hirezy.composeuI.feature.basic.R

@Composable
fun TreeScreen() {
    WeScreen(title = "Tree", description = "树型菜单", horizontalAlignment = Alignment.Start) {
        WeTreeNode("ComposeUI") {
            WeTreeNode("安装包") {
                repeat(10) { index ->
                    ApkNode("v${index + 1}.0")
                }
